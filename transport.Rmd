...
* Approximately 45% of the state’s population does not live within a reasonable distance of a bus stop. 
* Almost 474,000 people in Rhode Island have no physical access to public transit. 
* Transportation cost burdens for moderate income households are lowest in and around population centers and highest along the western edge of the state. 
* The average transportation cost burden for moderate income households is 23% of household income, which is 44% higher than the US average. 
* Compared to the general population, people over the age of 64 have the least access to public transit, experience the lowest frequencies of transit service, live in the least walkable areas, and experience the highest transportation cost burden.
